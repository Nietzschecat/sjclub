...
public class ExcelView extends AbstractExcelView {
	...
	public ExcelView(String sjclubname, String sheetName, String[] properties, String[] titles, Integer[] widths, Converter[] converters, Collection<?> data, String[] contents) {
		this.sjclubname = sjclubname;
	...
	public void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (StringUtils.isNotEmpty(sjclubname)) {
			response.setHeader("Content-disposition", "attachment; sjclubname=" + URLEncoder.encode(sjclubname, "UTF-8"));
		} else {
	...
	public void setFileName(String sjclubname) {
		this.sjclubname = sjclubname;
	}
